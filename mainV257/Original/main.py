import os, json, datetime, hashlib, string, random, telegram, asyncio, urllib.request, time
...
INFO = "Руский язык\n1) Исправлений ошибок\n2) Переименование папки main в RLCP\nEnglish language\n1) Bug fixed\n2) Renaming the main folder in RLCP"
